...
namespace NET_SP.Controllers
{
    public class PhimsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaPhim,TenPhim,ThoiLuong,NgayCongChieu")] Phim phim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaPhim,TenPhim,ThoiLuong,NgayCongChieu")] Phim phim)
        {
            if (id != phim.MaPhim)
            {
                return NotFound();
